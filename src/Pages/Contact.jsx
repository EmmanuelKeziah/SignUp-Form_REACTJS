    ...
    <section className="background flex  justify-center items-center max-w-[90vw] mx-auto">
        ...
        <div className=" p-5 ">
          ...
          >
            ...
            <input
              ...
              value={firstName}
              onChange={(e) => console.log(setFirstName(e.target.value))}
            />
            {firstName}
            ...
            <button
              type="submit"
              className="bg-white text-blue-600 font-bold p-2 rounded hover:bg-blue-700 hover:text-white transition duration-300 max-w-[200px] mx-auto"
            >
              Sign Up
            </button>
          </form>
      ...
      <main className=" card-2 min-w-[400px] mx-auto p-5 min-h-[200px] shadow-lg flex flex-wrap">
        {users.map((user, index) => (
          <div
            className="bg-purple-200 p-3 m-2 rounded-lg shadow-lg text-black"
            key={index}
          >
            <h2>
